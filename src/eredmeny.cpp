...
public:
    ...
    {
        RCLCPP_INFO(this->getlogger(), "kotangens jelek összeadása");
        pub = this->create_publisher<stdmsgs::msg::Float32>("eredmeny", 10);
        sub1 = this->create_subscription<std_msgs::msg::Float32>( "cotg1", 10,std::bind(&eredmeny::callback1, this, std::placeholders::1));
        sub2 = this->create_subscription<std_msgs::msg::Float32>("cotg2", 10,std::bind(&eredmeny::callback2, this, std::placeholders::_1));
    }
