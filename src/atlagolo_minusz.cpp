...
public:
    Atlagolo()
    : Node("atlagolo_m"), count_(0)
    {
        subscription_ = this->create_subscription<std_msgs::msg::Int32>(
            "szamok_minusz", 10, std::bind(&Atlagolo::number_callback, this, std::placeholders::_1));

        publisher_ = this->create_publisher<std_msgs::msg::Float64>("atlag_minusz", 10);
    }
